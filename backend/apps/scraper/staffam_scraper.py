...
"Teamwork"), поэтому по ним фильтр гораздо точнее. Обратная сторона:
"Full Stack JS Developer" без единого фронтенд-слова в заголовке всё равно
проходит, потому что у него в skills явно стоят React.js/Vue js/Redux.
